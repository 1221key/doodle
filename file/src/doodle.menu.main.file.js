(function ($) {
	var img = window.GlobalSpace.DiscussDomain + '/plugins/wPaint/file/img/icons-menu-main-file.png';

  // extend menu
  $.extend(true, $.fn.kDoodle.menus.main.items, {
    save: {
      icon: 'generic',
      title: '保存',
      img: img,
  ...
  $.fn.kDoodle.extend({
    ...
    //    $img = $('<img class="kDoodle-modal-img"/>').attr('src', images[i]);
    //    $img = $('<div class="kDoodle-modal-img-holder"></div>').append($img);
